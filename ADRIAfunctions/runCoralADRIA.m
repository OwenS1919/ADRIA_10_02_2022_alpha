%% I HAVE CHANGED THE CODE BELOW TO INCLUDE LSHSites and LSH_params
function [Y, Y_CF, LSHSites] = runCoralADRIA(intervs, crit_weights, coral_params, sim_params, ...
                           TP_data, site_ranks, strongpred, ...
                           n_reps, wave_scen, dhw_scen, LSH_params)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Y_CF = zeros(timesteps, n_species, nsites, N, n_reps);
...
for i = 1:N
    ...
    for j = 1:n_reps
        [Y(:, :, :, i, j), Y_CF(:, :, :, i, j), LSHSites] = coralScenario(scen_it, scen_crit, ...
                               c_params, sim_params, ...
                               TP_data, site_ranks, strongpred, ...
                               wave_scen(:, :, j), dhw_scen(:, :, j), LSH_params);
    end
end
