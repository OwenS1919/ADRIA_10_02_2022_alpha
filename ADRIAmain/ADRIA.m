classdef ADRIA < handle
    ...
    methods
        ...
        %% THIS FUNCTION DECLARATION HAS BEEN CHANGED TO INCLUDE LSHSites
        function [Y, Y_CF, LSHSites] = run(obj, X, runargs)
            arguments
               obj
               X table
               runargs.sampled_values logical
               runargs.nreps {mustBeInteger}
               runargs.LSH_params cell = []
            end
            ...
            %% THIS HAS BEEN CHANGED TO INCLUDE LSHSites and Y_CF and LSH_params
            [Y, Y_CF, LSHSites] = runCoralADRIA(interv, crit, coral, obj.constants, ...
                     obj.TP_data, obj.site_ranks, obj.strongpred, nreps, ...
                     w_scens, d_scens, LSH_params);
        end
